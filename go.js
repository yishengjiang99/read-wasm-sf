...
// refer to Module (if they choose; they can also define Module)
  ...
  (function() {
   var loadPackage = function(metadata) {
      ...
      var PACKAGE_NAME = 'go.data';
      var REMOTE_PACKAGE_BASE = 'go.data';
          ...
          DataRequest.prototype.byteArray = byteArray;
            ...
            for (var i = 0; i < files.length; ++i) {
              DataRequest.prototype.requests[files[i].filename].onload();
                ...
                Module['removeRunDependency']('datafile_go.data');

      };
      Module['addRunDependency']('datafile_go.data');
   ...
   loadPackage({"files": [{"filename": "/file.sf2", "start": 0, "end": 31281186, "audio": 0}], "remote_package_size": 31281186, "package_uuid": "7a192722-9993-4c79-a633-83d568c43966"});
...
var INITIAL_INITIAL_MEMORY = Module['INITIAL_MEMORY'] || 360710144;if (!Object.getOwnPropertyDescriptor(Module, 'INITIAL_MEMORY')) Object.defineProperty(Module, 'INITIAL_MEMORY', { configurable: true, get: function() { abort('Module.INITIAL_MEMORY has been replaced with plain INITIAL_INITIAL_MEMORY (the initial value can be provided on Module, but after startup the value is only looked for on a local variable of that name)') } });
...
var wasmSourceMapFile = 'go.wasm.map';
if (!isDataURI(wasmBinaryFile)) {
...
var ASM_CONSTS = {
  2468: function() {return withBuiltinMalloc(function () { return allocateUTF8(Module['UBSAN_OPTIONS'] || 0); });},  
 7335: function() {return STACK_BASE;},  
 7358: function() {return STACK_MAX;},  
 22428: function() {var setting = Module['printWithColors']; if (setting != null) { return setting; } else { return ENVIRONMENT_IS_NODE && process.stderr.isTTY; }}
};
...
/** @type {function(...*):?} */
var _initWithPreload = Module["_initWithPreload"] = createExportWrapper("initWithPreload");

/** @type {function(...*):?} */
var _malloc = Module["_malloc"] = createExportWrapper("malloc");

/** @type {function(...*):?} */
var _getSample = Module["_getSample"] = createExportWrapper("getSample");
...
var ___heap_base = Module['___heap_base'] = 5453120;
