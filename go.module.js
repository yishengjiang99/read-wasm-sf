...
// refer to Module (if they choose; they can also define Module)
  ...
  (function() {
   var loadPackage = function(metadata) {
      ...
      var PACKAGE_NAME = 'go.module.data';
      var REMOTE_PACKAGE_BASE = 'go.module.data';
          ...
          DataRequest.prototype.byteArray = byteArray;
            ...
            for (var i = 0; i < files.length; ++i) {
              DataRequest.prototype.requests[files[i].filename].onload();
                ...
                Module['removeRunDependency']('datafile_go.module.data');

      };
      Module['addRunDependency']('datafile_go.module.data');
   ...
   loadPackage({"files": [{"filename": "/file.sf2", "start": 0, "end": 31281186, "audio": 0}], "remote_package_size": 31281186, "package_uuid": "8d783b0d-312d-4f50-ab4c-281933eb1277"});
...
var wasmBinaryFile = 'go.module.wasm';
...
var wasmSourceMapFile = 'go.module.wasm.map';
if (!isDataURI(wasmBinaryFile)) {
...
var ASM_CONSTS = {
  2424: function() {return withBuiltinMalloc(function () { return allocateUTF8(Module['UBSAN_OPTIONS'] || 0); });},  
 7295: function() {return STACK_BASE;},  
 7318: function() {return STACK_MAX;},  
 22380: function() {var setting = Module['printWithColors']; if (setting != null) { return setting; } else { return ENVIRONMENT_IS_NODE && process.stderr.isTTY; }}
};
...
var ___heap_base = Module['___heap_base'] = 5453248;
